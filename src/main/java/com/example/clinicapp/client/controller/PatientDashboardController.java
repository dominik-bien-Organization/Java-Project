...
import com.example.clinicapp.client.files.FileHelper;
import com.example.clinicapp.common.interfaces.IPatient;
import com.example.clinicapp.common.model.Doctor;
import com.example.clinicapp.common.network.*;
import com.example.clinicapp.client.service.DoctorService;
import com.example.clinicapp.client.service.RecipeService;
import com.example.clinicapp.client.util.AlertMessage;
...
public class PatientDashboardController implements Initializable {
    ...
    private void handleLogout() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/clinicapp/client/PatientPage.fxml"));
    ...
    private void handleConfirmVisit() {
        ...
        if (selectedDoctorName != null && selectedHour != null && selectedDate != null) {
            ...
            alert.errorMessage("Uzupełnij wszystkie pola");
        }
    }
